...
```php
use SkywalkerLabs\LaravelLivewireTables\View\Filters\DateRangeFilter;
...
```js
'vendor/SkywalkerLabs/laravel-livewire-tables/resources/js/laravel-livewire-tables-thirdparty.min.js';
```

or in your app.js

```js
import '../../vendor/SkywalkerLabs/livewire-tables/resources/js/laravel-livewire-tables-thirdparty.min.js';
```
