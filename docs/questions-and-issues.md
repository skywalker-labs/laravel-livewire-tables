...
If you have general questions not related to any issues you may post a [discussion](https://github.com/SkywalkerLabs/laravel-livewire-tables/discussions).

If you have found a reproducable bug please create an [issue](https://github.com/SkywalkerLabs/laravel-livewire-tables/issues).

If you would like other help you can join the [discord channel - details here](https://github.com/SkywalkerLabs/laravel-livewire-tables/discussions/1252/).

If you've found a bug regarding security please mail anthony@SkywalkerLabs.com instead of using the issue tracker.

We welcome contributions, and suggestions from the community, which will be reviewed by the Core Team

# Core Maintainers:
- [Anthony Rappa](https://github.com/SkywalkerLabs)
