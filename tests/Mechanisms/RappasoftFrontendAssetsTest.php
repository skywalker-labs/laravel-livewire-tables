...
class SkywalkerLabsFrontendAssetsTest extends TestCase
{
    ...
    public function test_styles()
    {
        ...
        $this->assertStringStartsWith('<link href="/SkywalkerLabs/laravel-livewire-tables/core.min.css" rel="stylesheet" />', ltrim($assets->tableStyles()));
    ...
    public function test_third_partystyles()
    {
        ...
        $this->assertStringStartsWith('<link href="/SkywalkerLabs/laravel-livewire-tables/thirdparty.css" rel="stylesheet" />', ltrim($assets->tableThirdPartyStyles()));
