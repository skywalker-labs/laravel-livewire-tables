...
final class RefreshConfigurationTest extends TestCase
{
    ...
    {
        $this->assertFalse($this->basicTable->refreshStatus());

        $this->basicTable->setRefreshTime(5000);

        $this->assertSame('5000', $this->basicTable->refreshStatus());
    }
    ...
    public function test_refresh_keep_alive_can_be_set(): void
    {
        ...
        $this->assertSame('keep-alive', $this->basicTable->refreshStatus());
    }
    ...
    public function test_refresh_visible_can_be_set(): void
    {
        ...
        $this->assertSame('visible', $this->basicTable->refreshStatus());
    }
    ...
    public function test_refresh_method_can_be_set(): void
    {
        ...
        $this->assertSame('myRefreshMethod', $this->basicTable->refreshStatus());
    }
    ...
    public function test_poll_with_seconds_format(): void
    {
        ...
        $this->assertSame('10000', $this->basicTable->refreshStatus());
    }
    ...
    public function test_poll_with_minutes_format(): void
    {
        ...
        $this->assertSame('60000', $this->basicTable->refreshStatus());
    }
    ...
    public function test_poll_with_hours_format(): void
    {
        ...
        $this->assertSame('7200000', $this->basicTable->refreshStatus());
    }
    ...
    public function test_poll_with_multiple_minutes(): void
    {
        ...
        $this->assertSame('300000', $this->basicTable->refreshStatus());
    }
